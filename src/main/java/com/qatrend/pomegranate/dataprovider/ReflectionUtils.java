...
final class ReflectionUtils {
     ...
     * @param type
     *            - The type to check.
     * @return boolean <code>true</code> If the Class represented by the type has a 1 argument constructor defined that
     *         accepts a String.
     */
     ...
     * @param type
     *            - The type to check.
     * @return boolean <code>true</code> If the Class represented by the type has a default constructor defined.
     */
     ...
     * @return Object An array of type {@link DefaultCustomType}
     */
     ...
     *            newly constructed array.
     * 
     * @return Object An array of the type that was specified.
     */
     ...
     * @return Object An initialized object that represents the primitive data type.
     */
     ...
     * @param valueToAssign
     *            - The value to initialize with.
     * @return Object An initialized object that represents the Wrapper data type.
     */
     ...
     * @return boolean <code>true</code> if type is a primitive array type.
     */
     ...
     * @param type
     *            - The type which is to be checked.
     * @return boolean <code>true</code> if type is a wrapper array type.
     */
